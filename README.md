...
## About The Project
Webbit is a `Reddit-like` app built with Ruby 3.0 and Ruby on Rails 7.0.3 following a new premium training course by [Andy Leverenz](https://hellorails.io/).
## Demo
...
* Create a new Rails app by running the `rails new` *(and the project name)* command after installing Rails. E.g., In your terminal, type `rails new webbit` to create the project. Now you can [clone the repo](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository).
